...
rocket.v3.3.py: Internal version of smallRNA/longRNA pre-processing and expression profiling script uusing ab initio approach
...
iSyTE2_LumiALL: Script written for unpublished iSyTE tool. Processes Illumina Microarray's data.
